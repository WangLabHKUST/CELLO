...
```
Alternatively, one can build the docker image from scratch. The docker file is uploaded to this repository. Download the [Dockerfile](./CELLOR/Dockerfile) and [CELLOR.R](./CELLOR/CELLO.R) into a directory, then build the image from there by:
```
